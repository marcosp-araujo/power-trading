...
from src.model_tools import Model_Manager
from src.data_tools import Data_Manager
from src.config_tools import Config_Manager
from src.config_tools import variables_dictionary
...
def plot_sliding_window(data:Data_Manager, 
    ...
    for x_batch, y_batch in data.x_train_window.take(1):
        window = x_batch[0].numpy().flatten()
        target = y_batch[0].numpy()
